...
public class Lab01 {
    public static void main(String[] args) {
        ...
        int[] list4 = {6, 5, 4, 3};
        System.out.println(partitionable2to1(list1, new int[list1.length], 0));
        System.out.println(partitionable(list2, new int[list2.length], 0));
        System.out.println(partitionable(list3, new int[list3.length], 0));
        System.out.println(partitionable(list4, new int[list4.length], 0));
